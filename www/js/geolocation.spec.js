...
// 	it('Should fail to get coordinates from town if it does not start with the town name', function(done) {
// 		mockOutHTTPGet("PA, Narberth");
// 		geolocation.getCoordinatesFromTown("PA, Narberth").then(function(coordinates) {
// 		}, function(error) {
// 			done();
// 		});
// 		$scope.$apply();
