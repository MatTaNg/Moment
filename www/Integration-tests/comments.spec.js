...
describe('Moment Service', function() {
    ...
    it('Should be able to comment on a moment', function(done) {
    ...
    it('Should be able to edit a comment on a moment', function(done) {
        done();
        $rootScope.$apply();
    });

    it('Should be able to delete a comment on a moment', function(done) {
        done();
        $rootScope.$apply();
    });

    it('Should be able to reply to a comment on a moment', function(done) {
        done();
        $rootScope.$apply();
    });
